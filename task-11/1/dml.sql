...
VALUES 
('r1', 101, 5000.00, 2, 4, 'OCCUPIED', '2026-02-14'),
('r2', 102, 8000.00, 3, 5, 'AVAILABLE', NULL),
('r3', 103, 2000.00, 1, 1, 'OCCUPIED', '2026-02-15');
...
('g1', 'Petrov Vasya', 18, 'r1', '2026-01-06', '2026-02-14', 'SETTLED'),
('g2', 'Seledkin Petya', 20, 'r3', '2026-01-05', '2026-02-15', 'SETTLED');
