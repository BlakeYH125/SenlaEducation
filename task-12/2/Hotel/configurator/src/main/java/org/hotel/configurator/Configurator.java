...
import org.hotel.annotations.ConfigType;
...
public class Configurator {
    ...
    private static Properties getProperties(String fileName) throws Exception {
        ...
        InputStream input = Configurator.class.getClassLoader().getResourceAsStream(fileName);

        if (input == null) {
            throw new RuntimeException("Файл конфигурации '" + fileName + "' не найден в resources");
        }
