public class HotelMain {
    public static void main(String[] args) {
        ...
        administrator.addNewRoom(new Room(1, 3000, Status.AVAILABLE)); //проверка добавления комнаты
        administrator.addNewRoom(new Room(2, 4000, Status.AVAILABLE));
        administrator.addNewRoom(new Room(3, 5000, Status.AVAILABLE));
        ...
        administrator.setStatus(2, Status.IN_SERVICE); //проверяем установку статуса и смены стоимости
